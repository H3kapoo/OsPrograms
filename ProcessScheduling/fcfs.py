#PROCESS SCHEDULING EXERCISE FIRST COME FIRST SERVED
...
#Preinitialize First Come First Served
sProc = startProc()
currTime = pArrival[sProc]
pQueue.put(sProc)

print('='*19,' READY QUEUE FCFS','='*18)
print(f"<{str(currTime).center(3)}> Put in {sProc+1}")

#While we still have burst,do First Come First Served
while sum(pBurst) != 0:
